...
public class PauseSaving {
    ...
    BufferedImage main_background, save_frame, save_frame_selected, save_text, save_underline, save_warning, new_save, new_save_selected;
    ...
    public void load_image()
    {
        try {
            ...
            save_underline=ImageIO.read(getClass().getClassLoader().getResourceAsStream("Title/save_underline.png"));
    ...
    public void draw(Graphics2D g2) {
        ...
        g2.drawImage(save_text, 170, 120, 300, 92, null);
        g2.drawImage(save_underline, 160, 230, 716, 40, null);
        ...
        for (int i = start_slot; i < Math.min(start_slot + gp.total_save_game+1, start_slot + 4); i++) {
            ...
            if (i != gp.total_save_game) {
                ...
                g2.drawString(save[i].last_saved, 650, 355 + factor * num);
