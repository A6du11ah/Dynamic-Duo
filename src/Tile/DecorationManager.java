...
public class DecorationManager {
    ...
    public void setDecorationValues()
    {
        ...
        decoration_setter(current_dec,  1000, 620, 120, 170, 20 );
        decoration_setter(current_dec,  1130, 620, 120, 170, 20 );
        decoration_setter(current_dec,  1260, 620, 120, 170, 20 );
        decoration_setter(current_dec,  1390, 620, 120, 170, 20 );
        decoration_setter(current_dec,  1000, 750, 120, 170, 20 );
        decoration_setter(current_dec,  1130, 750, 120, 170, 20 );
        decoration_setter(current_dec,  1260, 750, 120, 170, 20 );
        decoration_setter(current_dec,  1390, 750, 120, 170, 20 );
        ...
        decoration_setter(current_dec ,1790,900,  110, 110, 18 );
        ...
        /*decoration_setter(current_dec, 1610, 3960, 90, 75, 36);
        decoration_setter(current_dec, 1750, 3300, 90, 75, 36);
        decoration_setter(current_dec, 3020, 4490, 90, 75, 36);
        decoration_setter(current_dec, 1390, 3370, 90, 75, 36);
        decoration_setter(current_dec, 3480, 6430, 90, 75, 36);
        decoration_setter(current_dec, 1260, 5620, 90, 75, 36);
        decoration_setter(current_dec, 2730, 4090, 90, 75, 36);
        decoration_setter(current_dec, 2930, 3380, 90, 75, 36);
        decoration_setter(current_dec, 3320, 4670, 90, 75, 36);
        decoration_setter(current_dec, 1560, 3910, 90, 75, 36);
        decoration_setter(current_dec, 3940, 1020, 90, 75, 36);
        decoration_setter(current_dec, 2780, 3050, 90, 75, 36);
        decoration_setter(current_dec, 3860, 1330, 90, 75, 36);
        decoration_setter(current_dec, 3900, 5360, 90, 75, 36);
        decoration_setter(current_dec, 1620, 5880, 90, 75, 36);
        decoration_setter(current_dec, 3450, 4820, 90, 75, 36);
        decoration_setter(current_dec, 2010, 3370, 90, 75, 36);
        decoration_setter(current_dec, 2080, 4170, 90, 75, 36);
        decoration_setter(current_dec, 3600, 4970, 90, 75, 36);
        decoration_setter(current_dec, 1440, 4810, 90, 75, 36);
        decoration_setter(current_dec, 3920, 5290, 90, 75, 36);
        decoration_setter(current_dec, 980, 6650, 90, 75, 36);*/
        ...
        decoration_setter(current_dec, 1432, 4336, 88, 98, 28);
        ...
        decoration_setter(current_dec ,1120,7985,  120, 120, 49 );
        ...
        decoration_setter(current_dec ,5580,5148,  360, 360, 70 );


        //house
        decoration_setter(current_dec ,5360,5380,  280, 350, 51 );
        ...
        decoration_setter(current_dec, 6172,6288, 121, 110, 61);
        ...
        decoration_setter(current_dec, 7644,745, 350, 420, 95);
        ...
        decoration_setter(current_dec, 5964,2766, 210, 278, 89);
